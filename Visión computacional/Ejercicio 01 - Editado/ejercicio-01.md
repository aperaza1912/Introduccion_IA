...
También puede verlo localmente en: [Ejercicio 01 - Alan Peraza - Notebook](AlanPeraza_13_YOLO_ultralytics.ipynb)

**Path:** *Visión computacional\Ejercicio 01 - Editado\AlanPeraza_13_YOLO_ultralytics.ipynb*
...
En las fotos de Ultralytics, YOLO pudo distinguir personas en la foto de Zidane, y personas y autobuses en la foto *bus*. En la foto que yo seleccioné, detectó personas, osos, ovejas y perros. 

En la foto subida por mí, hay una nutria a la izquierda de la persona que el modelo no reconoció en ningún caso, por lo que casi todos los objetos evidentes fueron etiquetados por el modelo. Sólo el de la persona fue etiquetado de manera correcta. Con respecto a los otros objetos, que son todos animales, creo que el error de clasificación puede deberse principalmente a que las clases no se encuentran en COCO. El búho (clasificado como “oso”) tiene otra característica que pudo interferir en su correcto etiquetado: su tamaño. 

Las predicciones de CLI y la de model, no coinciden con la imagen, a excepción de la persona etiquetada. 
